...
class AdminSubscriptionPlanViewSet(AdminSubscriptionPermissionMixin, viewsets.ModelViewSet):
...
@extend_schema(tags=['Admin Subscriptions'])
class AdminUserSubscriptionViewSet(AdminSubscriptionPermissionMixin, viewsets.ModelViewSet):
...
@extend_schema(tags=['Admin Subscriptions'])
class AdminSubscriptionUsageViewSet(AdminSubscriptionPermissionMixin, viewsets.ReadOnlyModelViewSet):
