...
def build_khota_job_input(*, source=None, collection=None, subject=None, input_payload=None, parameters=None):
    payload = _as_mapping(input_payload, "input")
    params = _as_mapping(parameters, "parameters")
...
def build_task_input(*, user, task_type, source=None, collection=None, subject=None, input_payload=None, parameters=None):
...
def complete_job(job, result_payload, metadata=None):
    ...
    job.security_flags = dict((metadata or {}).get("security_flags") or job.security_flags or {})
