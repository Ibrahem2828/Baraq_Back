...
class AdminRoleViewSet(AdminPermissionMixin, viewsets.ModelViewSet):
...
class AdminReadOnlyViewSet(AdminPermissionMixin, viewsets.ReadOnlyModelViewSet):
    filter_backends = [filters.SearchFilter, filters.OrderingFilter]
...
@extend_schema(tags=['Admin Sources'])
class AdminSourceViewSet(AdminPermissionMixin, viewsets.ModelViewSet):
